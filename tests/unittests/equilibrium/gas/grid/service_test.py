...
import exogibbs.equilibrium.gas.grid.service as eqgridmod
import exogibbs.equilibrium.gas.grid.build as gridbuildmod
...
def test_verify_exogibbs_grid_against_fastchem_tracks_worst_point_and_species(monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        fake_create_fastchem_point_solver,
    )

    results = gridbuildmod._verify_exogibbs_grid_against_fastchem(
        setup,
...
def test_interpolate_equilibrium_grid_forwards_interpax_options(monkeypatch):
    ...
    monkeypatch.setattr(
        "exogibbs.equilibrium.gas.grid.interpolation.Interpolator3D",
        StubInterpolator3D,
    )
