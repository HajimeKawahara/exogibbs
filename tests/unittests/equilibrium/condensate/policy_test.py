...
def test_historical_policy_module_preserves_object_identity():
    from exogibbs.condensates import fixed_support_v2_policy as legacy

    assert (
        legacy.FixedSupportV2ProductionPolicy
        is FixedSupportV2ProductionPolicy
    )
    assert (
        legacy.fixed_support_v2_production_policy
        is fixed_support_v2_production_policy
    )
