...
if ( "$mode" == "a100_broad100_brepeat_api_rescue_slim" ) then
    if ( "$custom_batch_size" == "" ) then
        echo "usage: $0 a100_broad100_brepeat_api_rescue_slim N_EVAL"
        exit 2
    endif
    set iterations = 100
    set warmup = 0
    ...
    set lambda_initialization = "--lambda-initialization best_residual"
    set residual_tolerance_multiplier = "--residual-tolerance-multiplier 1.0e9"
    set support_candidate_mode = "--support-candidate-mode api_fallback_rescue_prune"
    set support_candidate_prune_floors = "--support-candidate-prune-floors 1e-5,1e-3"
    set support_candidate_neighbor_union = "--disable-support-candidate-neighbor-union"
...
if ( "$mode" == "a100_broad100_brepeat_api_cached_rescue_slim" ) then
    if ( "$custom_batch_size" == "" ) then
        echo "usage: $0 a100_broad100_brepeat_api_cached_rescue_slim N_EVAL"
        exit 2
    endif
    set iterations = 100
    set warmup = 0
    ...
    set lambda_initialization = "--lambda-initialization best_residual"
    set residual_tolerance_multiplier = "--residual-tolerance-multiplier 1.0e9"
    set support_candidate_mode = "--support-candidate-mode api_cached_fallback_rescue_prune"
    set support_candidate_prune_floors = "--support-candidate-prune-floors 1e-5,1e-3"
    set support_candidate_neighbor_union = "--disable-support-candidate-neighbor-union"
    set label = "a100_broad100_brepeat${custom_batch_size}_api_cached_rescue_slim"
endif
