...
def elemental_n_mass_fraction_to_mole_ratio(
    ...
    """Convert the N2 law's total elemental-N mass fraction to mole ratio.

    This is an atomic-N mole ratio. The corresponding N2-equivalent ratio is
    one half of the returned value.
    """
