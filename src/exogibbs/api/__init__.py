...
def __getattr__(name):
    ...
    if name in {
        ...
        return {
            ...
            "CondensateFixedSupportV2Preset": CondensateFixedSupportV2Preset,
            "FIXED_SUPPORT_V2_VALIDATED_PRESET": FIXED_SUPPORT_V2_VALIDATED_PRESET,
            "HEAD_ROUTE_V2": HEAD_ROUTE_V2,
