...
def prepare_ykb4_setup() -> ChemicalSetup:
    ...
    * formula_matrix is fixed, built from df_molname.
    ...
    formula_matrix_np, elems, specs = build_formula_matrix(df_molname)
    ...
    molecules, T_table_np, mu_table_np, grid_lens = extract_and_pad_gibbs_data(gibbs_matrices)
    ...
    return ChemicalSetup(
        ...
        metadata=("source:JANAF", f"num_species:{formula_matrix.shape[1]}"),
    )
